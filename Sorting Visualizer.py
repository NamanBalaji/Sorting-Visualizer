# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 14:50:27 2020
...
canvas = Canvas(root, width=600, height=380, bg='yellow')
canvas.grid(row=1, column=0, padx=10, pady=5)

#User Interface Area
#Row[0]
Label(UI_frame, text="Algorithm: ", bg='green').grid(row=0, column=0, padx=5, pady=5, sticky=W)
